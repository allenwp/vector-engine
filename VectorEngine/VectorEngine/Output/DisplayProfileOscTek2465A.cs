...
{
    /// <summary>
    /// Display Profile for the Tektronix 2465A 350 MHz Oscilloscope
    /// </summary>
    public class DisplayProfileOscTek2465A : DisplayProfile
    {
        public override float AspectRatio { get; set; } = 1.187f; // TODO

        public override float FullBrightnessOutput { get; set; } = 0.0f;
        ...
        /// </summary>
        private static float blankingLength = 14f; // TODO
